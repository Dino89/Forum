...
class ThemasControllerTest < ActionController::TestCase
  ...
  test "should create thema" do
    assert_difference('Thema.count') do
      post :create, thema: { Author: @thema.Author, Beschreibung: @thema.Beschreibung, Bild: @thema.Bild, RaumID: @thema.RaumID, Title: @thema.Title }
    end
  ...
  test "should update thema" do
    put :update, id: @thema, thema: { Author: @thema.Author, Beschreibung: @thema.Beschreibung, Bild: @thema.Bild, RaumID: @thema.RaumID, Title: @thema.Title }
    assert_redirected_to thema_path(assigns(:thema))
  end
