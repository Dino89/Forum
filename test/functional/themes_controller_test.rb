...
class ThemesControllerTest < ActionController::TestCase
  ...
  test "should create theme" do
    assert_difference('Theme.count') do
      post :create, theme: { description: @theme.description, id: @theme.id, picture: @theme.picture, room_id: @theme.room_id, title: @theme.title, user_id: @theme.user_id }
    end
  ...
  test "should update theme" do
    put :update, id: @theme, theme: { description: @theme.description, id: @theme.id, picture: @theme.picture, room_id: @theme.room_id, title: @theme.title, user_id: @theme.user_id }
    assert_redirected_to theme_path(assigns(:theme))
  end
